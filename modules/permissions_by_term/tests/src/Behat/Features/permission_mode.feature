...
Feature: Permission mode
  ...
  Scenario: Editor cannot access disallowed node edit form
    ...
    And I open the node edit form by node title "No term relation"
  ...
  Scenario: Editor cannot access disallowed node edit form
    ...
    And I should see text matching "Access denied"
    Then I open the node edit form by node title "No term relation"
    And I should see text matching "Access denied"
    Then I open the node edit form by node title "Editor can access"
